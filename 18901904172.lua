...
Tab1:CreateToggle("Auto Roll", function(value)
    ...
    while autoRollEnabled do
        ...
        game:GetService("ReplicatedStorage"):WaitForChild("Events"):WaitForChild("Roll"):InvokeServer(unpack(args))
...
local autoCashoutEnabled = false

Tab1:CreateToggle("Auto Cashout", function(value)

    autoCashoutEnabled = value

    while autoCashoutEnabled do

        game:GetService("ReplicatedStorage"):WaitForChild("Events"):WaitForChild("Cashout"):FireServer()
...
local nukeAllEnabled = false

Tab1:CreateToggle("Nuke All", function(value)

    nukeAllEnabled = value

    while nukeAllEnabled do

        for i = 1, 10 do

            game:GetService("MarketplaceService"):SignalPromptProductPurchaseFinished(

                game.Players.LocalPlayer.UserId, 1908617606, true
